...
I then used the command `head` to extract the first 6 rows of the dataset. 
...
The `plot()` function generates the following plot. 

```
> plot(cars)
```

![](https://github.com/venatisriya/assignment12/blob/main/Picture%201.jpg)
...
The `car_func.carb_hist()` function gives me the following histogram. 
...
![](https://github.com/venatisriya/assignment12/blob/main/Picture%202.jpg)

Overall, I found the process of using R Markdown to be easy and very interesting. 
